...
export default function Home() {
  return (
    <main className="mx-auto flex w-full max-w-310 flex-1 flex-col items-center justify-center px-[clamp(14px,3vw,40px)] py-[clamp(22px,4vw,44px)] text-center">
      ...
      <p className="mt-5.5 font-display text-av-label tracking-av-wider text-av-yellow av-glow-yellow animate-av-caret">
